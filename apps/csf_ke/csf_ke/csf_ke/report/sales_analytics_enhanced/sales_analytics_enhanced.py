...
class Analytics:
    ...
    def get_data(self):
        if self.filters.tree_type in ["Customer", "Supplier", "User"]:
    ...
    def get_sales_transactions_based_on_customers_or_suppliers(self):
        ...
        elif self.filters.tree_type == "User":
            entity = "owner as entity"
            entity_name = "owner as entity_name"
        else:
        ...
        if self.filters.doc_type == "Sales Order":
            filters = {
                ...
                "billing_status": (self.filters.billing_status),
            }
    ...
    def get_period(self, posting_date):
        if self.filters.range == "Weekly":
            ...
            period = (
                _(str(self.months[posting_date.month - 1]))
                + " "
